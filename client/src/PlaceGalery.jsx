...
export default function PlaceGalery({place}){
    ...
    <div className="relative">
            <div className='lg:mx-auto lg:w-photowidth'>
            <div className="grid grid-cols-[2fr_1fr] lg:grid-cols-[1fr,0.49fr] lg:m-auto lg:max-w-fit  lg:gap-2 lg:mb-10 rounded-3xl overflow-hidden">
                <div>
                    {place.photos?.[2] && (
                        <div className="">
        ...
        <button onClick={()=>{setShowAllPhotos(true)}} className="lg:-ml-16 flex gap-1 items-center absolute bottom-2 right-2 lg:w-64  lg:left-2/3 lg:right-2/3/4 py-2 px-4 rounded-2xl shadow-md shadow-gray-500 bg-white">
