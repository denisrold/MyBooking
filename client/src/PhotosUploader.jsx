   ...
   <>
    ...
    <div className="mt-2 gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <div className='h-32 flex relative' key={link} >
            ...
            <button 
            className="absolute bottom-1 left-2 bg-black opacity-70 p-1 text-white rounded-xl cursor-pointer hover:scale-105 hover:opacity-80"
